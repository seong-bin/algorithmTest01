...
//		int solution1 = solution(new int[] {2, 1, 3, 2}, 2);
		int solution2 = solution(new int[] {1, 1, 9, 1, 1, 1}, 0);
//		System.out.println("내가 요청한 문서가 인쇄되는 순서 = "+solution1);
		System.out.println("내가 요청한 문서가 인쇄되는 순서 = "+solution2);
	}
